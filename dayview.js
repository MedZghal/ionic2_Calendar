...
var DayViewComponent = /** @class */ (function () {
    ...
    DayViewComponent.prototype.ngOnInit = function () {
        ...
        this.currentDateChangedFromParentSubscription = this.calendarService.currentDateChangedFromParent$.subscribe(function (currentDate) {
            ...
            setTimeout(function () {
                ...
                //change
                if (_this.scrollToHour !== '0') {
                    // if (this.scrollToHour > 0) {
                    var hourColumns_1 = _this.elm.nativeElement.querySelector('.dayview-normal-event-container').querySelectorAll('.calendar-hour-column');
                    var me_1 = _this;
                    var ColScroll = _this.getHourColumnLabels().indexOf(me_1.scrollToHour);

                    setTimeout(function () {
                        me_1.initScrollPosition = hourColumns_1[ColScroll].offsetTop;
                    }, 0);
                }
            },0);
        });
    ...
    DayViewComponent.prototype.ngAfterViewInit = function () {
        ...
        // if (this.scrollToHour > 0) {
            ...
            var me_1 = this;
            var ColScroll = this.getHourColumnLabels().indexOf(me_1.scrollToHour) === -1 ? this.getHourColumnLabels().indexOf(me_1.scrollToHour.split(':')[0]+':00'):this.getHourColumnLabels().indexOf(me_1.scrollToHour);
            setTimeout(function () {
                me_1.initScrollPosition = hourColumns_1[ColScroll].offsetTop;
            }, 0);
        }
    ...
    DayViewComponent.prototype.onSlideChanged = async  function () {
    ...
    DayViewComponent.prototype.move = function (direction) {
        ...
        setTimeout(function () {
            ...
            if (_this.scrollToHour !== '0') {
                    ...
                    var me_1 = _this;
                    // var ColScroll = _this.getHourColumnLabels().indexOf(me_1.scrollToHour) === -1 ? _this.getHourColumnLabels().indexOf(me_1.scrollToHour.split(':')[0]+':00'):_this.getHourColumnLabels().indexOf(me_1.scrollToHour);
                    var ColScroll = _this.getHourColumnLabels().indexOf(me_1.scrollToHour);
                    console.log(me_1.scrollToHour);

                    setTimeout(function () {
                        me_1.initScrollPosition = hourColumns_1[0].offsetTop;
                        me_1.initScrollPosition = hourColumns_1[ColScroll].offsetTop;
                    }, 0);
                }
        },0);
